...
class GradeFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'literature1'=> $this->faker->biasedNumberBetween($min = 1, $max = 9, $function = 'sqrt'),
            'literature2'=> $this->faker->biasedNumberBetween($min = 1, $max = 9, $function = 'sqrt'),
            'literature3'=> $this->faker->biasedNumberBetween($min = 1, $max = 9, $function = 'sqrt'),
            'literature4'=> $this->faker->biasedNumberBetween($min = 1, $max = 9, $function = 'sqrt'),
            'literature5'=> $this->faker->biasedNumberBetween($min = 1, $max = 9, $function = 'sqrt'),
            'literature6'=> $this->faker->biasedNumberBetween($min = 1, $max = 9, $function = 'sqrt'),
            'literature7'=> $this->faker->biasedNumberBetween($min = 1, $max = 9, $function = 'sqrt'),
            'literature8'=> $this->faker->biasedNumberBetween($min = 1, $max = 9, $function = 'sqrt'),
            'literature9'=> $this->faker->biasedNumberBetween($min = 1, $max = 9, $function = 'sqrt'),
            'user_id' => $user->id,
            /*'user_name' => $user->name,*/
        ];
    }
